...
from src.domain.models import Booking, BookingStatus, CreditBalance, CreditPackage, CreditType
...
class FileStorage:
    ...
    def save_booking(self, booking: Booking) -> None:
        ...
        bookings_data[booking.id] = {
            ...
            } if booking.ride_class else None,
    ...
    def has_existing_booking_for_criteria(self, criteria) -> bool:
        ...
        for booking in all_bookings:
            if (booking.criteria.weekday == criteria.weekday and
                booking.criteria.instructor == criteria.instructor and
                booking.criteria.time == criteria.time and
                booking.criteria.studio == criteria.studio and
                booking.status in [BookingStatus.PENDING, BookingStatus.BOOKED]):
                return True
    ...
    def _dict_to_booking(self, data: dict) -> Booking:
        ...
        return Booking(
            ...
            booked_at=datetime.fromisoformat(data['booked_at']) if data['booked_at'] else None,
